...
// ─── Inlined proximity logic (from @platform/proximity) ────────────────────
...
// Seed healer locations (Berlin demo)
...
export default function HealersPage() {
    ...
    const filteredHealers = useMemo(() => {
        ...
        return result;
    }, [search, selectedModalities, selectedLanguage, maxPrice, showOnlineOnly, showNearMe, myPosition, nearbyMap]);
